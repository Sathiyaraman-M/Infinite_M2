...
public class UserBookmarkHttpClient(HttpClient httpClient)
{
    ...
    {
        return await httpClient.GetFromJsonAsync<Result<bool>>($"api/user/bookmarks/blog/{blogId}");
    }
    
    public async Task<IResult<bool>> ToggleBlogBookmark(Guid blogId)
    {
        return await httpClient.GetFromJsonAsync<Result<bool>>($"api/user/bookmarks/blog/{blogId}/toggle");
    }
    ...
    {
        return await httpClient.GetFromJsonAsync<Result<bool>>($"api/user/bookmarks/project/{blogId}");
    }
    
    public async Task<IResult<bool>> ToggleProjectBookmark(Guid blogId)
    {
        return await httpClient.GetFromJsonAsync<Result<bool>>($"api/user/bookmarks/project/{blogId}/toggle");
    }
